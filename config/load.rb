...
Errbit::Config = Configurator.run(
  ...
  use_notify_of_exceed:      ['ERRBIT_USE_NOTIFY_OF_EXCEED'],
  specific_period_minutes:   ['ERRBIT_SPECIFIC_PERIOD_MINUTES'],
  specific_error_count:      ['ERRBIT_SPECIFIC_ERROR_COUNT'],
